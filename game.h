...
class Game : public graphics::AnimationEventListener,
 ...
 public:
  ...
  Game(const int &width, const int &height) {
    gameboard.Initialize(width, height);
  }

  int GetScore() const { return score_; }
  bool HasLost() const { return Game_lost_; }
  ...
  void Init() {
    player_.SetX(350);
    player_.SetY(280);
    gameboard.AddMouseEventListener(*this);
    gameboard.AddAnimationEventListener(*this);
  }
  ...
  graphics::Image &GetGameScreen() { return gameboard; }
