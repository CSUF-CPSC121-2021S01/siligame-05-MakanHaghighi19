...
class GameElement {
 public:
  GameElement() : GameElement(0, 0, 38, 38) {}
  ...
  virtual void Draw(graphics::Image &gameboard) = 0;
  virtual void Move(const graphics::Image &gameboard) = 0;
  bool IntersectsWith(GameElement *intersect_Element);
  bool IsOutOfBounds(const graphics::Image &gameboard);
